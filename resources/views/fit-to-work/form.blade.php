                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <label class="tipe-btn flex items-center gap-3 p-4 border-2 rounded-xl cursor-pointer transition
                                      {{ old('tipe', '') === 'internal' ? 'border-blue-600 bg-blue-50' : 'border-gray-200 hover:border-blue-300' }}">
                        ...
                        <label class="tipe-btn flex items-center gap-3 p-4 border-2 rounded-xl cursor-pointer transition
                                      {{ old('tipe', '') === 'vendor' ? 'border-amber-500 bg-amber-50' : 'border-gray-200 hover:border-amber-300' }}">
