            ...
            <form method="POST" action="{{ route('pegawai.pengambilan.store') }}">
                ...
                <div class="mb-5">
                    ...
                    <div class="relative">
                        ...
                        <div id="nid-spinner" class="hidden absolute right-3 top-3.5 w-4 h-4 border-2 border-blue-300 border-t-blue-600 rounded-full animate-spin"></div>
            ...
            nipTimer = setTimeout(async () => {
                try {
                    ...
                    if (data.found) {
                        ...
                        document.getElementById('nid-bidang').textContent = data.bidang ? `– ${data.bidang}` : '';
