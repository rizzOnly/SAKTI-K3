...
<body class="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-slate-100">
    ...
    <div class="max-w-2xl mx-auto px-4 pb-12">
        <div class="bg-white rounded-2xl p-8 shadow-[0_0_0_1px_rgba(0,0,0,.06),0_4px_24px_rgba(0,61,124,.08)]">
            ...
            <form method="POST" action="<?php echo e(route('vendor.registrasi.store')); ?>">
                <?php echo csrf_field(); ?>

                
                <script id="vendor-data" type="application/json">
                    <?php echo json_encode($vendorsWpo->map(function($v) {
                ...
                <div class="bg-amber-50 rounded-xl p-4 mb-6 border border-amber-100">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="cms_vendor_id" id="select-vendor" onchange="onVendorChange()"
                                class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-amber-400 bg-white transition <?php $__errorArgs = ['cms_vendor_id'];
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $vendorsWpo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($v->id); ?>" <?php echo e(old('cms_vendor_id') == $v->id ? 'selected' : ''); ?>>
                                <?php echo e($v->nama_vendor); ?>

                            </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </select>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['cms_vendor_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                ...
                <div class="bg-green-50 rounded-xl p-4 mb-6 border border-green-100">
                    ...
                    <div id="pekerja-wrap">
                        ...
                        <div id="pekerja-select-wrap" class="hidden">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['pekerja_nama'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <input type="text" name="no_wa_pic" id="input-wa" value="<?php echo e(old('no_wa_pic')); ?>"
                        ...
                        <div>
                            ...
                            <input type="email" name="email_pic" value="<?php echo e(old('email_pic')); ?>"
...
<?php /**PATH C:\laragon\www\k3-pltgu\resources\views/vendor/form-registrasi.blade.php ENDPATH**/ ?>