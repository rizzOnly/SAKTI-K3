<div class="mb-5">
    ...
    <input type="date" name="tanggal_pengajuan"
           value="<?php echo e(old('tanggal_pengajuan', today()->format('Y-m-d'))); ?>"
...
<?php /**PATH C:\laragon\www\k3-pltgu\resources\views/pegawai/_form-tanggal-field.blade.php ENDPATH**/ ?>