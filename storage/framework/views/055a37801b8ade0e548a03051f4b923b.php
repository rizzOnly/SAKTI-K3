...
<head>
    ...
    <title><?php echo e($article->title); ?> – K3 PLN Sengkang</title>
    <meta name="description" content="<?php echo e(Str::limit(strip_tags($article->content), 160)); ?>">
...
<body class="bg-gray-50">
    ...
    <article class="max-w-3xl mx-auto px-4 py-10">
        ...
        <div class="flex items-center gap-3 mb-5">
            <span class="category-badge badge-<?php echo e($article->category); ?>">
            ...
            <span class="text-gray-400 text-sm">
                <?php echo e($article->published_at->translatedFormat('d F Y')); ?>
    ...
    <section class="max-w-3xl mx-auto px-4 pb-16">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <a href="<?php echo e(route('artikel.show', $rel->id)); ?>"
               class="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition group">
                ...
                <img src="<?php echo e(Storage::url($rel->thumbnail)); ?>"
                ...
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <div class="p-3">
                    <span class="text-xs text-blue-600 font-medium capitalize"><?php echo e($rel->category); ?></span>
                    <h3 class="text-sm font-semibold text-gray-800 mt-1 leading-snug line-clamp-2"><?php echo e($rel->title); ?></h3>
                </div>
            </a>
    ...
    <footer class="bg-[#003D7C] text-white py-6 mt-4">
        <div class="max-w-3xl mx-auto px-4 text-center text-blue-300 text-xs">
            © <?php echo e(date('Y')); ?> PT PLN Nusantara Power – Unit Pembangkitan Sengkang
        </div>
    </footer>

</body>
</html>
<?php /**PATH C:\laragon\www\k3-pltgu\resources\views/artikel-detail.blade.php ENDPATH**/ ?>