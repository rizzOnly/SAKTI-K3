    ...
    <section id="fit-to-work" class="section">
        <div class="section-inner">
            ...
            <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:16px">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $fitToWorkVendor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ftw): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div style="background:#fff;border-radius:16px;padding:18px;box-shadow:0 1px 4px rgba(0,0,0,.06);border:1px solid #e5e7eb;border-top:4px solid #16a34a">
                    ...
                    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:10px">
                        ...
                        <span style="font-size:11px;color:#9ca3af">
                            s/d <?php echo e($ftw->tanggal_selesai->format('d/m/Y')); ?>
                    ...
                    <div style="font-size:12px;color:#6b7280;margin-bottom:8px">
                        <?php echo e($ftw->nama_perusahaan); ?>
                    ...
                    <div style="background:#f0fdf4;border-radius:10px;padding:8px 12px;margin-bottom:8px">
                        ...
                        <div style="font-size:13px;color:#374151;font-weight:600"><?php echo e($ftw->nama_pekerjaan); ?></div>
                    </div>

                    
                    <div style="display:flex;align-items:center;gap:6px;font-size:12px;color:#9ca3af">
                        📅 <?php echo e($ftw->tanggal_mulai->format('d/m/Y')); ?> – <?php echo e($ftw->tanggal_selesai->format('d/m/Y')); ?>

                    </div>

                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ftw->dokter_nama): ?>
                    <div style="margin-top:8px;font-size:11px;color:#9ca3af">
                        Diperiksa oleh: <?php echo e($ftw->dokter_nama); ?>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ftw->tanggal_periksa): ?>
                        · <?php echo e($ftw->tanggal_periksa->format('d/m/Y')); ?>
